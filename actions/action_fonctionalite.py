...
class ActionFunctionality(Action):
    ...
    def get_functionalities(self):
        functionalities = [
            ...
            "Je peux vous donner la liste des salles disponibles pour une date donnée, l'heure de début et la durée souhaité.",
            "Je peux aussi vérifier pour vous si une salle donnée est disponible ou pas",
    ...
    def get_functionalities_html(self):
        ...
        htmlIntro = "<div class='functionality-intro'>{0}</div>".format(INTRO_FUNCTIONALITY)
